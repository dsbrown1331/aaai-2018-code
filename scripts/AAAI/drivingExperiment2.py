...
filePath = "/home/daniel/Code/PeARL_BIRL/data/carExperiment2_2/"
...
for bound_type in bounds:
    ...
    for numDemo in numDemos:  
        ...
        for rep in range(num_reps):
            filename = filePath + evalPolicyName + "_alpha" + str(alpha) + "_chain" + str(chain_len) + "_step" + str(mcmc_step)+ "0000_L1sampleflag" + str(sample_flag) + "_demoLength" + str(demo_length)+ "_mcRollout" + str(mc_numRollouts) + "_rep" + str(rep)+ ".txt";
            #print filename
            f = open(filename,'r')   
