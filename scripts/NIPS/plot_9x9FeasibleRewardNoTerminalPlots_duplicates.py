...
filePath = "/home/dsbrown/Code/PeARL_BIRL/data/experiment6_4/"
...
for bound_type in bounds:
    ...
    plt.savefig("upperBoundError9x9gridNoTerminal_YesDups_alpha" + str(alpha) + ".png")
    ...
    plt.legend(loc='best',fontsize=19)
    plt.tight_layout()
    plt.savefig("accuracy9x9gridNoTerminal_expYesDups_alpha" + str(alpha) + ".png") 
