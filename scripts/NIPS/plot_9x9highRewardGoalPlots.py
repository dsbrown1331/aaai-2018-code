...
#plot results for experiment2_1
...
filePath = "/home/daniel/Code/PeARL_BIRL/data/experiment2_1/"
...
for bound_type in bounds:
    ...
    plt.savefig("upperBoundError9x9gridgoal_exp2_1.png")
    ...
    plt.legend(loc='best',fontsize=19)
    plt.tight_layout()
    plt.savefig("accuracy9x9gridgoal_exp2_1.png") 
