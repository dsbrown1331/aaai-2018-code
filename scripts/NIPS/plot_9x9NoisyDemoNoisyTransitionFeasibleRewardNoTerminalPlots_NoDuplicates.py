...
filePath = "/home/dsbrown/Code/PeARL_BIRL/data/experiment8_1/"
...
for bound_type in bounds:
    ...
    for numDemo in numDemos:  
        ...
        for rep in range(num_reps):
            if(step <= 0.005):
                filename = filePath + "numdemos" +  str(numDemo) + "_alpha" + str(alpha) + "_chain" + str(chain_length) +  "_step" + str(step) + "000_L1sampleflag" + str(sample_flag) +  "_rolloutLength" + str(rolloutLength) +  "_stochastic" + str(stochastic) + "_randActionProb" + str(rand_action_prob) + "00000_rep" + str(rep)+ ".txt"
            #print "rep:",rep
            elif(step < 0.1):
                filename = filePath + "numdemos" +  str(numDemo) + "_alpha" + str(alpha) + "_chain" + str(chain_length) +  "_step" + str(step) + "0000_L1sampleflag" + str(sample_flag) +  "_rolloutLength" + str(rolloutLength) + "_stochastic" + str(stochastic) + "_randActionProb" + str(rand_action_prob) + "00000_rep" + str(rep)+ ".txt"
#            else:
