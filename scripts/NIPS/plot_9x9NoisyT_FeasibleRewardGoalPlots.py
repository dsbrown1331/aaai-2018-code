...
filePath = "/home/daniel/Code/PeARL_BIRL/data/experiment5_2/"
...
for bound_type in bounds:
    ...
    for numDemo in numDemos:  
        ...
        for rep in range(num_reps):
            ...
            filename = filePath + "numdemos" +  str(numDemo) + "_alpha" + str(alpha) + "_chain" + str(chain_length) +  "_step" + str(step) + "0000_L1sampleflag" + str(sample_flag) +  "_rolloutLength" + str(rolloutLength) + "_stochastic1_rep" + str(rep)+ ".txt"
            #print filename
            f = open(filename,'r')   
