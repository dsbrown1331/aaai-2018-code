...
tol = 0.0001
gamma = 0.95
burn = 10 #TODO play with this
skip = 5
numDemos = 1
delta_conf = 0.95
bounds = ["VaR 95",  "VaR 90", "WFCB"]
fmts = ['o-','s--','^-.', '*:','>-','d--']
...
filePath = "/home/dsbrown/Code/PeARL_BIRL/data/carExperiment1_2/"
...
for bound_type in bounds:
    ...
    for rep in range(num_reps):
        filename = filePath + "alpha" + str(alpha) + "_chain" + str(chain_length) + "_step" + str(step) + "0000_L1sampleflag" + str(sample_flag) + "_rolloutLength" + str(rolloutLength) + "_rep" + str(rep)+ ".txt";
        #print filename
        f = open(filename,'r')   
    ...
    print "bound error", np.mean(bound_error)
