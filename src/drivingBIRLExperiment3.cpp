...
//In this experiment I'm going to remove the tailgating feature for rewards and see what happens.
...
int main()
{
    ...
    for(unsigned int rep = 0; rep < reps; rep++)
    {
        ...
        string filename = "simple_" + evalPolicyName 
        ...
        cout << filename << endl; 
        ofstream outfile("data/carExperiment3_1/" + filename);
